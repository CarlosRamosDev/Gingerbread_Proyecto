...
public class Topic_1 {
    ...
    private String topic1_1_1;
    private String topic1_1_2;

    public Topic_1() {
    }

    public Topic_1(String topic1_1, String topic1_1_1, String topic1_1_2) {
        this.topic1_1 = topic1_1;
        this.topic1_1_1 = topic1_1_1;
        this.topic1_1_2 = topic1_1_2;
    }

    public String getTopic1_1() {
        return topic1_1;
    }

    public void setTopic1_1(String topic1_1) {
        this.topic1_1 = topic1_1;
    }

    public String getTopic1_1_1() {
        return topic1_1_1;
    }

    public void setTopic1_1_1(String topic1_1_1) {
        this.topic1_1_1 = topic1_1_1;
    }

    public String getTopic1_1_2() {
        return topic1_1_2;
    }

    public void setTopic1_1_2(String topic1_1_2) {
        this.topic1_1_2 = topic1_1_2;
    }

    public void imprimirTema1_1() {
        topic1_1 = "Una Partícula Subatómicas es una partícula más pequeña que el átomo. Puede ser una partícula elemental o una compuesta, a su vez, por otras partículas subatómicas, como son los quarks, que componen los protones y neutrones.\n"
                + "Estructura atómica\n"
    ...
    public void imprimirTema1_1_1() {
        ...
        System.out.println(topic1_1_1);
    }

    public void imprimirTema1_1_2() {
        topic1_1_2 = "La radiactividad es una propiedad de los isotopos que son \"inestables\", es decir, que se mantienen en un estado excitado en sus capas electrónicas o nucleares, con lo que, para alcanzar su estado fundamental, deben perder energía.\n"
                + " Es un fenómeno químico-físico por el cual algunos cuerpos o elementos químicos, llamados radiactivos, emiten radiaciones que tienen la propiedad de impresionar placas radiográficas fecisterografias, ionizar gases, producir fluorescencia, atravesar cuerpos opacos a la luz ordinaria, entre otros.\n"
