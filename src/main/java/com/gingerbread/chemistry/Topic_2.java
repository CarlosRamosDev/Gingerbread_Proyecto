...
public class Topic_2 {
    ...
    private String topic1_2_1;
    private String topic1_2_2;
    private String topic1_2_3;
    private String topic1_2_4;

    public Topic_2() {
    }

    public Topic_2(String topic1_2, String topic1_2_1, String topic1_2_2, String topic1_2_3, String topic1_2_4) {
        this.topic1_2 = topic1_2;
        this.topic1_2_1 = topic1_2_1;
        this.topic1_2_2 = topic1_2_2;
        this.topic1_2_3 = topic1_2_3;
        this.topic1_2_4 = topic1_2_4;
    }

    public String getTopic1_2() {
        return topic1_2;
    }

    public void setTopic1_2(String topic1_2) {
        this.topic1_2 = topic1_2;
    }

    public String getTopic1_2_1() {
        return topic1_2_1;
    }

    public void setTopic1_2_1(String topic1_2_1) {
        this.topic1_2_1 = topic1_2_1;
    }

    public String getTopic1_2_2() {
        return topic1_2_2;
    }

    public void setTopic1_2_2(String topic1_2_2) {
        this.topic1_2_2 = topic1_2_2;
    }

    public String getTopic1_2_3() {
        return topic1_2_3;
    }

    public void setTopic1_2_3(String topic1_2_3) {
        this.topic1_2_3 = topic1_2_3;
    }

    public String getTopic1_2_4() {
        return topic1_2_4;
    }

    public void setTopic1_2_4(String topic1_2_4) {
        this.topic1_2_4 = topic1_2_4;
    }
    //Métodos
    public void imprimirTema1_2() {
        ...
        System.out.println(topic1_2);
    }

    public void imprimirTema1_2_1() {
        topic1_2_1 = """
                1.2.1 Teoría ondulatoria de la luz
                Propiedades de las ondas:\s
                ...
                Huygens en el año 1678, describe y explica lo que hoy se considera como leyes de reflexión y refracción. Define a la luz como un movimiento ondulatorio semejante al que se produce con el sonido. Young demostró experimentalmente el hecho paradójico que se daba en la teoría corpuscular de que la suma de dos fuentes luminosas puede producir menos luminosidad que por separado. En una pantalla negra practica dos minúsculos agujeros muy próximos entre sí: al acercar la pantalla al ojo, la luz de un pequeño y distante foco aparece en forma de anillos alternativamente brillantes y oscuros. Para poder describir una onda electromagnética podemos utilizar los parámetros habituales de cualquier onda:\s
                ...
                • Frecuencia (v): Número de oscilaciones del campo por unidad de tiempo. Es una cantidad inversa al periodo.\s
                • Longitud de onda (λ' '): Es la distancia lineal entre dos puntos equivalentes de ondas sucesivas.\s
