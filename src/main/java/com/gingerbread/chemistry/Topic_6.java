...
public class Topic_6 {
    public static Topic Topic() {
        ...
        topic.setDescription("""
                ...
                El trazado isotópico ha permitido estudiar así, sin perturbarlo, el funcionamiento de todo lo que tiene vida, de la célula al organismo entero. En biología, numerosos adelantos realizados en el transcurso de la segunda mitad del siglo XX están vinculados a la utilización de la radioactividad: funcionamiento del genoma (soporte de la herencia), metabolismo de la célula, fotosíntesis, transmisión de mensajes químicos (hormonas, neurotransmisores) en el organismo.               \s
                Los isótopos radioactivos se utilizan en la medicina nuclear, principalmente en las imágenes médicas, para estudiar el modo de acción de los medicamentos, entender el funcionamiento del cerebro, detectar una anomalía cardiaca, descubrir las metástasis cancerosas. Las radiaciones y la radioterapia.
